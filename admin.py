...
# --- 3. HÀM XUẤT PDF (FIX LỖI CODEC 'UTF-8') ---
def export_pdf(row):
    try:
        # Sử dụng fpdf2
        pdf = FPDF()
        ...
        # Cấu hình Font (Cần file arial.ttf trong cùng thư mục để hiển thị tiếng Việt)
        font_path = "arial.ttf"
        font_name = 'Helvetica'
        ...
        fields = {
            ...
            "Mã QHNS": "ma_qhns", "SĐT": "sdt_ke_toan", "Kế toán": "ke_toan"
        }
        ...
        # ĐIỂM SỬA LỖI CHÍNH: Trả về bytes nhị phân sạch
...
try:
    ...
    with st.sidebar:
        ...
        # Nút kiểm tra cập nhật dẫn link về thư mục lưu trữ
        st.link_button("🔄 Kiểm tra cập nhật", "https://your-storage-link.com", use_container_width=True)
        
        # PHÂN TÍCH CHUYÊN SÂU NẰM DƯỚI CÙNG SIDEBAR
        st.write("---")
